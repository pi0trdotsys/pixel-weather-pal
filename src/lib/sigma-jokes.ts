...
// Trzymaj każdą linijkę możliwie krótką (cel: ~55 znaków) — to trafia
// na footer widgetu (jedna linia, ellipsize), więc długie zdania i tak
// się utną z "…". Krótsze = czytelne na widgecie bez ucinania.
